...
export default function PelzerServiceAreaPage() {
  return (
      ...
      <section className="border-b border-slate-200 bg-slate-50">
        <div className="mx-auto max-w-6xl px-4 py-14 md:py-20">
          ...
          <h1 className="mt-3 text-3xl font-bold tracking-tight text-slate-900 md:text-4xl">
            Pelzer Concrete Contractor for Driveways, Patios & Slabs
          </h1>
          <p className="mt-4 max-w-3xl text-sm text-slate-600 md:text-base">
            Imperium Concrete is proud to serve Pelzer, SC as a full-service
            <span className="font-semibold"> Pelzer concrete contractor</span>.
          ...
          <div className="grid gap-8 md:grid-cols-2 md:items-start">
            ...
            <div>
              <h2 className="text-xl font-bold tracking-tight text-slate-900 md:text-2xl">
                Pelzer Driveways and Sidewalks
              </h2>
              <p className="mt-3 text-sm text-slate-600 md:text-base">
                This monolithic slab and driveway was poured in the Pelzer, SC area
                and was 4 inches thick with footings.  Our team graded, compacted, formed, set rebar/vapor barrier and poured this project over 2 days. 
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="border-b border-slate-200 bg-slate-50">
        <div className="mx-auto max-w-6xl px-4 py-12 md:py-16">
          ...
          <h2 className="text-2xl font-bold tracking-tight text-slate-900 mb-6">
            Concrete Services We Provide in Pelzer, SC
          </h2>
          ...
          <div className="grid gap-6 md:grid-cols-2 text-sm md:text-base text-slate-600">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
              ...
              <p>
                As a Pelzer concrete driveway specialist, we pour new driveways, replace
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
              ...
              <p>
                ...
                and outdoor living areas around Pelzer homes. Drainage and grading
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
              ...
              <p>
                ...
                and vapor-barrier reinforced concrete for builders and homeowners in Pelzer.
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
              ...
              <p>
                We serve Pelzer businesses, churches, apartment communities, and contractors
      ...
      <section className="bg-slate-900 px-4 py-12 text-slate-50 md:py-16">
        <div className="mx-auto max-w-4xl text-center">
          <h2 className="text-2xl font-bold tracking-tight md:text-3xl">
            Need Concrete Work in Pelzer, SC?
          </h2>
          <p className="mt-4 max-w-2xl mx-auto text-sm text-slate-200 md:text-base">
            ...
            or pouring a slab foundation, our Pelzer serving team is ready to help.
          </p>
