...
export default function WilliamstonServiceAreaPage() {
  return (
    <main className="bg-white">
      ...
      <section className="border-b border-slate-200 bg-slate-50">
        <div className="mx-auto max-w-6xl px-4 py-14 md:py-20">
          ...
          <h1 className="mt-3 text-3xl font-bold tracking-tight text-slate-900 md:text-4xl">
            Williamston Concrete Contractor for Driveways, Patios & Slabs
          </h1>
          <p className="mt-4 max-w-3xl text-sm text-slate-600 md:text-base">
            Imperium Concrete is proud to serve Williamston, SC as a full-service
            <span className="font-semibold"> Williamston concrete contractor</span>.
      ...
      {/* Williamston IMAGE BLOCK */}
      <section className="border-b border-slate-200 bg-white">
        <div className="mx-auto max-w-6xl px-4 py-12 md:py-16">
          <div className="grid gap-8 md:grid-cols-2 md:items-start">
            
            {/* Image Placeholder */}
            <div className="rounded-3xl overflow-hidden border border-slate-300 bg-slate-100 shadow-sm h-320px md:h-320px flex items-center justify-center">
              {/* DROP A REAL IMAGE HERE */}
              <span className="text-slate-400 text-sm">
                <img
                  src={imperiumwilliamston}
            ...
            <div>
              <h2 className="text-xl font-bold tracking-tight text-slate-900 md:text-2xl">
                Williamston Patios and Foundations
              </h2>
      ...
      <section className="border-b border-slate-200 bg-slate-50">
        <div className="mx-auto max-w-6xl px-4 py-12 md:py-16">
          ...
          <h2 className="text-2xl font-bold tracking-tight text-slate-900 mb-6">
            Concrete Services We Provide in Williamston, SC
          </h2>
          ...
          <div className="grid gap-6 md:grid-cols-2 text-sm md:text-base text-slate-600">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
              ...
              <p>
                As a Williamston concrete driveway specialist, we pour new driveways, replace
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
              ...
              <p>
                ...
                and outdoor living areas around Williamston homes. Drainage and grading
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
              ...
              <p>
                ...
                and vapor-barrier reinforced concrete for builders and homeowners in Williamston.
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
              ...
              <p>
                We serve Williamston businesses, churches, apartment communities, and contractors
      ...
      <section className="bg-slate-900 px-4 py-12 text-slate-50 md:py-16">
        <div className="mx-auto max-w-4xl text-center">
          <h2 className="text-2xl font-bold tracking-tight md:text-3xl">
            Need Concrete Work in Williamston, SC?
          </h2>
          <p className="mt-4 max-w-2xl mx-auto text-sm text-slate-200 md:text-base">
            ...
            or pouring a slab foundation, our Williamston serving team is ready to help.
          </p>
    ...
    <main className="bg-white">
      ...
      <section className="border-b border-slate-200 bg-slate-50">
        <div className="mx-auto max-w-6xl px-4 py-14 md:py-20">
          ...
          <h1 className="mt-3 text-3xl font-bold tracking-tight text-slate-900 md:text-4xl">
            Greer Concrete Contractor for Driveways, Patios & Slabs
          </h1>
          <p className="mt-4 max-w-3xl text-sm text-slate-600 md:text-base">
            Imperium Concrete is proud to serve Greer, SC as a full-service
            <span className="font-semibold"> Greer concrete contractor</span>.
            Our office can help respond quickly,
            provide detailed on-site assessments, and deliver high-quality residential
            and commercial concrete work throughout the Upstate.
          </p>
      ...
      <section className="border-b border-slate-200 bg-white">
        <div className="mx-auto max-w-6xl px-4 py-12 md:py-16">
          <div className="grid gap-8 md:grid-cols-2 md:items-start">
            ...
            <div>
              <h2 className="text-xl font-bold tracking-tight text-slate-900 md:text-2xl">
                Greer Concrete Driveway Extensions
              </h2>
              <p className="mt-3 text-sm text-slate-600 md:text-base">
      ...
      <section className="border-b border-slate-200 bg-slate-50">
        <div className="mx-auto max-w-6xl px-4 py-12 md:py-16">
          ...
          <h2 className="text-2xl font-bold tracking-tight text-slate-900 mb-6">
            Concrete Services We Provide in Greer, SC
          </h2>
          ...
          <div className="grid gap-6 md:grid-cols-2 text-sm md:text-base text-slate-600">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
              <h3 className="text-lg font-semibold text-slate-900 mb-2">Concrete Driveways</h3>
              <p>
                As a Greer concrete driveway specialist, we pour new driveways, replace
                cracked or aging driveways, add extensions, and build long rural or sloped
                driveways. All pours meet or exceed PSI and reinforcement
                standards, as well as ACI Guidlines on expansion cuts.
              </p>
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
              ...
              <p>
                We install backyard patios, stamped concrete, lifestyle spaces, borders,
                and outdoor living areas around Greer homes. Drainage and grading
                are handled properly to protect your foundation.
              </p>
            </div>
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
              ...
              <p>
                We pour monolithic slabs, shop slabs, garage slabs, foundations, footings,
                and vapor-barrier reinforced concrete for builders and homeowners in Greer.
                We can examine your engineered plans and make your project a reality.
              </p>
            </div>
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
              ...
              <p>
                We serve Greer businesses, churches, apartment communities, and contractors
                with sidewalks, ADA parking areas, commercial pads, retaining walls, equipment
                slabs, and more.
              </p>
            </div>
      ...
      <section className="bg-slate-900 px-4 py-12 text-slate-50 md:py-16">
        <div className="mx-auto max-w-4xl text-center">
          <h2 className="text-2xl font-bold tracking-tight md:text-3xl">
            Need Concrete Work in Greer, SC?
          </h2>
          <p className="mt-4 max-w-2xl mx-auto text-sm text-slate-200 md:text-base">
            Whether you're replacing a driveway, adding a patio, building a shop,
